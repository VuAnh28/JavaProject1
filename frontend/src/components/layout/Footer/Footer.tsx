            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <FooterColumn title="Về chúng tôi">
                        <p className="text-sm">
                            Chúng tôi chuyên thiết kế và thi công hồ cá Koi đẳng cấp,
                            mang đến không gian sống tuyệt vời cho cả bạn và những chú cá Koi quý giá.
                        </p>
                    </FooterColumn>
                ...
                <div className="mt-8 pt-8 border-t border-gray-700 text-center text-sm">
                    <p>&copy; {new Date().getFullYear()} Koi Pond Co. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
